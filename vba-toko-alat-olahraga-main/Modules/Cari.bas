...
Public Function cariRekapPenjualan(rowName As String, keywordName As String) As Range
    Dim baris As Long
    Dim dbArea As Range
    Dim cariKeyword As Range
    
    Set dbArea = wsRekapPenjualan.Range(rowName & "2:" & rowName & getBarisRekapPenjualan)
    Set cariKeyword = dbArea.Find(keywordName, , xlValues, xlWhole)
    Set cariRekapPenjualan = cariKeyword
End Function
