...
Public Function getBarisRekapPenjualan() As Long
    Call SetWorksheets
    getBarisRekapPenjualan = wsRekapPenjualan.Range("A" & wsRekapPenjualan.Rows.Count).End(xlUp).Row
End Function
